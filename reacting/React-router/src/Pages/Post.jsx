...
function Post(){
    ...
    return(
        <>
        <div className="w-[560px] mx-auto mt-24" >
            <div className="flex gap-3 items-center mb-3">
                <img className="h-16 w-16 rounded-full object-cover" src={user.image} alt="" />
                <div>
                    <p>{user.name}</p>
                    <p className="text-sm text-neutral-600">{user.profession}</p>
                </div>
            </div>
                <img className="h-80 w-[500px]" src={post.image} alt="" />
                <p className="mt-2s">{post.caption}</p>
